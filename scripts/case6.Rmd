...
ggplot(a.v3.fitted, aes(index, resc_std, color = gender, shape = race)) + geom_point()
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v31n.fitted, pos = 15) %>%
  ggplot(aes(interaction(gender, race), resm_std)) + geom_boxplot() +
  facet_wrap(~.sample, ncol = 5) +
  ylab(NULL) + xlab(NULL) + 
  theme(axis.text.y = element_blank(), axis.text.x = element_blank(),
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v31n.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.lcr, samples = autism.v31n.lcr, pos = 11) %>% 
  ggplot(aes(sample = resmcp)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v32n.fitted, pos = 15) %>%
  ggplot(aes(index, resm_std, color = gender, shape = race)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v32n.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.lcr, samples = autism.v32n.lcr, pos = 11) %>% 
  ggplot(aes(sample = resmcp)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v33n.fitted, pos = 2) %>%
  ggplot(aes(index, resm_std, color = gender, shape = race)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v33n.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.lcr, samples = autism.v33n.lcr, pos = 6) %>% 
  ggplot(aes(sample = resmcp)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v34n.fitted, pos = 2) %>%
  ggplot(aes(index, resm_std, color = gender, shape = race)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.fitted, samples = autism.v34n.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = a.v3.lcr, samples = autism.v34n.lcr, pos = 6) %>% 
  ggplot(aes(sample = resmcp)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
