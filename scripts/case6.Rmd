...
```{r}
ggplot(a.v2.fitted, aes(index, resm_std)) + geom_point()
ggplot(a.v2.fitted, aes(index, resc_std)) + geom_point()
...
```{r}
lineup(true = autism.fitted, samples = autism.v21n.fitted, pos = 5) %>%
  ggplot(aes(index, resm_std)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v21n.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.lcr, samples = autism.v21n.lcr, pos = 8) %>% 
  ggplot(aes(sample = resmcp)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v22.sim}
autism.v22.sim <- autism.sim(autism.mod, autism.repc2, seed = 7620)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v22n.fitted, pos = 5) %>%
  ggplot(aes(index, resm_std)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v22n.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v22n.lcr, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v23.sim}
autism.v23.sim <- autism.sim(autism.mod, autism.repc2, seed = 4739)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v23n.fitted, pos = 15) %>%
  ggplot(aes(index, resm_std)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v23n.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v23n.lcr, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v24.sim}
autism.v24.sim <- autism.sim(autism.mod, autism.repc2, seed = 8502)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v24n.fitted, pos = 15) %>%
  ggplot(aes(index, resm_std)) + geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v24n.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r}
lineup(true = autism.fitted, samples = autism.v24n.lcr, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + geom_qq() +
  geom_qq_line(color = "red") +
  facet_wrap(~.sample, ncol = 5)
```
