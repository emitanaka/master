...
```{r v11-sim}
v11.sim <- lin.sim(fit, df, seed = 1234)
```
...
v11.lin.sim.lcr <- purrr::map_dfr(1:19, function(i){
  ...
  tibble::tibble(df[1:(N-p),], reslc_lin)
})
```

```{r nullunit-v11}
v11.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v11.sim %>% filter(.n == i)
  m <- lmer(y ~ 1 +attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
  ...
  expand_grid(subjects, scenarios) %>% 
    dplyr::mutate(Vi = map2_dbl(subjects, scenarios, ~{
                        ind <- df %>% 
                          dplyr::mutate(index = 1:n()) %>% 
                          filter(subject==.x,
...
```{r v11n-plot}
lineup(true = lin.fitted, samples = v11.lin.sim.fitted, pos = 9) %>% 
...
```{r v11n-plot3}
lineup(true = lin.unit, samples = v11.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v11n-plot4}
lineup(true = lin.fitted, samples = v11.lin.sim.fitted, pos = 7) %>% 
...
```{r}
lineup(true = lin.lcr, samples = v11.lin.sim.lcr, pos = 9) %>% 
...
```{r v12-sim}
v12.sim <- lin.sim(fit, df, seed = 2345)
```
...
```{r nullunit-v12}
v12.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v12.sim %>% filter(.n == i)
  m <- lmer(y ~ 1 +attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v12n-plot1}
lineup(true = lin.fitted, samples = v12.lin.sim.fitted, pos = 7) %>% 
...
```{r v12n-plot22}
lineup(true = lin.fitted, samples = v12.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(index, resm_std, color = scenario)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v12n-plot3}
lineup(true = lin.unit, samples = v12.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v12n-plot-lcr}
lineup(true = lin.lcr, samples = v12.lin.sim.lcr, pos = 9) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
- Comparing with the conditional residual with the least confounded residual, the observed data plot for the conditional residual is easier to be detected. However, the observed data plot is hard to be distinguished among the the linup for least confounded residual.

### 3st replication

```{r v13-sim}
v13.sim <- lin.sim(fit, df, seed = 9876)
```
...
```{r nullunit-v13}
v13.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v13.sim %>% filter(.n == i)
  m <- lmer(y ~ 1 +attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v13n-plot1}
lineup(true = lin.fitted, samples = v13.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(fitted, resm_std)) +
  geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v13n-plot21}
lineup(true = lin.fitted, samples = v13.lin.sim.fitted, pos = 13) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v13n-plot3}
lineup(true = lin.unit, samples = v13.lin.sim.unit, pos = 8) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v13n-plot6}
lineup(true = lin.fitted, samples = v13.lin.sim.fitted, pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v13n-plot-lcr}
lineup(true = lin.lcr, samples = v13.lin.sim.lcr, pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v14-sim}
v14.sim <- lin.sim(fit, df, seed = 6839)
```
...
```{r nullunit-v14}
v14.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v14.sim %>% filter(.n == i)
  m <- lmer(y ~ 1 +attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v14n-plot1}
lineup(true = lin.fitted, samples = v14.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(fitted, resm_std)) +
  geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v14n-plot21}
lineup(true = lin.fitted, samples = v14.lin.sim.fitted, pos = 13) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v14n-plot3}
lineup(true = lin.unit, samples = v14.lin.sim.unit, pos = 8) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v14n-plot6}
lineup(true = lin.fitted, samples = v14.lin.sim.fitted, pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v14n-plot-lcr}
lineup(true = lin.lcr, samples = v14.lin.sim.lcr, pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
I randomly alter 4 reaction time value for each table corresponding to the gender and attitude (female with polite attitude, female with informal attitude, male with polite attitude, male with informal attitude) by adding 20% of the  mean value of the reaction time with respective to each table.

```{r}
set.seed(194253)
samp1 <- sample(21, 4)
f_pol <- round(as.numeric(df %>% filter(gender == "F", attitude == "pol") %>% summarise(mean(y)))*0.20,1)
repc.f.pol <- df %>% filter(gender == "F", attitude == "pol")
repc.f.pol[c(samp1),]$y <- repc.f.pol[c(samp1),]$y+f_pol
```

```{r}
set.seed(107623)
samp2 <- sample(21, 4)
m_pol <- round(as.numeric(df %>% filter(gender == "M", attitude == "pol") %>% summarise(mean(y)))*0.20,1)
repc.m.pol <- df %>% filter(gender == "M", attitude == "pol")
repc.m.pol[c(samp2),]$y <- repc.m.pol[c(samp2),]$y+m_pol
```

```{r}
set.seed(274302)
samp3 <- sample(21, 4)
m_inf <- round(as.numeric(df %>% filter(gender == "M", attitude == "inf") %>% summarise(mean(y)))*0.20,1)
repc.m.inf <- df %>% filter(gender == "M", attitude == "inf")
repc.m.inf[c(samp3),]$y <- repc.m.inf[c(samp3),]$y+m_inf
```

```{r}
set.seed(981234)
samp4 <- sample(21, 4)
f_inf <- round(as.numeric(df %>% filter(gender == "F", attitude == "inf") %>% summarise(mean(y)))*0.20,1)
repc.f.inf <- df %>% filter(gender == "F", attitude == "inf")
repc.f.inf[c(samp4),]$y <- repc.f.inf[c(samp4),]$y+f_inf
```

```{r}
repc2 <- rbind(repc.f.inf, repc.f.pol, repc.m.inf, repc.m.pol)
repc2 <- repc2[order(repc2$subject),]
```

```{r v2.mod}
v2.mod <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = repc2)
```

```{r}
v2.fitted <- lin.extract.fitted.mod(v2.mod, repc2)
v2.unit <- lin.extract.unit.mod(v2.mod, repc2)
v2.lcr <- lin.extract.lcr.mod(v2.mod, repc2)
```

### Observed plot

```{r}
ggplot(v2.fitted, aes(index, resm_std, color = subject)) + geom_point() + geom_hline(yintercept = 0)
ggplot(v2.fitted, aes(index, resc_std, color = subject)) + geom_point() + geom_hline(yintercept = 0)
ggplot(v2.fitted, aes(sample = resc_std)) + geom_qq() + geom_qq_line(color = "red")
ggplot(v2.lcr, aes(sample = reslc_lin)) + geom_qq() + geom_qq_line(color = "red")
```

- we may see that there are more points above the horizontal line. It may tends to be more outliers.
- The conditional residual seems that does not follow a normal distribution.


### 1st replication
```{r v21-sim}
v21.sim <- lin.sim(v2.mod, repc2, seed = 1234)
```
...
```{r nullunit-v11}
v21.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v21.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v21n-plot}
lineup(true = lin.fitted, samples = v21.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(fitted, resm_std)) +
  geom_point() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v21n-plot21}
lineup(true = lin.fitted, samples = v21.lin.sim.fitted, pos = 5) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot3}
lineup(true = lin.unit, samples = v21.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = lin.fitted, samples = v21.lin.sim.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = lin.lcr, samples = v21.lin.sim.lcr, pos = 14) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
### 2nd replication
```{r v22-sim}
v22.sim <- lin.sim(v2.mod, repc2, seed = 2632)
```
...
```{r nullunit-v22}
v22.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v22.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v22n-plot}
lineup(true = lin.fitted, samples = v22.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(fitted, resm_std)) +
  geom_point() +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot22}
lineup(true = lin.fitted, samples = v22.lin.sim.fitted, pos = 5) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v22n-plot3}
lineup(true = lin.unit, samples = v22.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = lin.fitted, samples = v22.lin.sim.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = lin.lcr, samples = v22.lin.sim.lcr, pos = 14) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
### 3rd replication
```{r v21-sim}
v23.sim <- lin.sim(v2.mod, repc2, seed = 1932)
```
...
```{r nullunit-v11}
v23.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v23.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v21n-plot}
lineup(true = lin.fitted, samples = v23.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(interaction(attitude, gender), resm_std)) +
  geom_boxplot() +
  facet_wrap(~.sample, ncol = 5)
```
...
```{r v21n-plot21}
lineup(true = lin.fitted, samples = v23.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot3}
lineup(true = lin.unit, samples = v23.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = lin.fitted, samples = v23.lin.sim.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = lin.lcr, samples = v23.lin.sim.lcr, pos = 20) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
### 4th replication
```{r v21-sim}
v24.sim <- lin.sim(v2.mod, repc2, seed = 8821)
```
...
```{r nullunit-v11}
v24.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v24.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v21n-plot}
lineup(true = lin.fitted, samples = v24.lin.sim.fitted, pos = 9) %>% 
  ggplot(aes(interaction(attitude, gender), resm_std)) +
  geom_boxplot() +
  facet_wrap(~.sample, ncol = 5)
```
...
##### Presence of outlying observations
```{r v21n-plot21}
lineup(true = lin.fitted, samples = v24.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot3}
lineup(true = lin.unit, samples = v24.lin.sim.unit, pos = 9) %>% 
  ggplot(aes(index, Vi)) +
  geom_point() +
  #geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = lin.fitted, samples = v24.lin.sim.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = lin.lcr, samples = v24.lin.sim.lcr, pos = 20) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
repc.f.pol <- df %>% filter(gender == "F", attitude == "pol")
repc.f.pol[c(samp5),]$y <- repc.f.pol[c(samp5),]$y+f_pol
```
...
repc.m.pol <- df %>% filter(gender == "M", attitude == "pol")
repc.m.pol[c(samp6),]$y <- repc.m.pol[c(samp6),]$y+m_pol
```
...
repc.m.inf <- df %>% filter(gender == "M", attitude == "inf")
repc.m.inf[c(samp7),]$y <- repc.m.inf[c(samp7),]$y+m_inf
```
...
repc.f.inf <- df %>% filter(gender == "F", attitude == "inf")
repc.f.inf[c(samp8),]$y <- repc.f.inf[c(samp8),]$y+f_inf
```

```{r}
repc3 <- rbind(repc.f.inf, repc.f.pol, repc.m.inf, repc.m.pol)
repc3 <- repc3[order(repc3$subject),]
```

```{r v3.mod}
v3.mod <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = repc3)
```

```{r}
v3.fitted <- lin.extract.fitted.mod(v3.mod, repc3)
v3.unit <- lin.extract.unit.mod(v3.mod, repc3)
v3.lcr <- lin.extract.lcr.mod(v3.mod, repc3)
```


```{r}
ggplot(v3.fitted, aes(index, resm_std)) + geom_point()
ggplot(v3.fitted, aes(index, resc_std)) + geom_point()
ggplot(v3.fitted, aes(sample = resc_std)) + geom_qq() + geom_qq_line(color = "red")
ggplot(v3.lcr, aes(sample = reslc_lin)) + geom_qq() + geom_qq_line(color = "red")
```
...
```{r}
v31.sim <- lin.sim(v3.mod, repc3, seed = 1234)
```
...
```{r nullunit-v32}
v31.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v31.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
lineup(true = lin.fitted, samples = v31.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
lineup(true = lin.fitted, samples = v31.lin.sim.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
lineup(true = lin.lcr, samples = v31.lin.sim.lcr, pos = 11) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r}
v32.sim <- lin.sim(v3.mod, repc3, seed = 4252)
```
...
```{r nullunit-v32}
v32.lin.sim.unit <- purrr::map_dfr(1:19, function(i){
  df <- v32.sim %>% filter(.n == i)
  m <- lmer(y ~ attitude + gender + 
              (1|subject) + (1|scenario),
            data = df)
...
```{r v32n-plot21, fig.height=6}
lineup(true = lin.fitted, samples = v32.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = lin.fitted, samples = v32.lin.sim.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = lin.lcr, samples = v32.lin.sim.lcr, pos = 11) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r}
v33.sim <- lin.sim(v3.mod, repc3, seed = 9263)
```
...
```{r v32n-plot21, fig.height=6}
lineup(true = lin.fitted, samples = v33.lin.sim.fitted, pos = 2) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = lin.fitted, samples = v33.lin.sim.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = lin.lcr, samples = v33.lin.sim.lcr, pos = 6) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r}
v34.sim <- lin.sim(v3.mod, repc3, seed = 6234)
```
...
```{r v32n-plot21, fig.height=6}
lineup(true = lin.fitted, samples = v34.lin.sim.fitted, pos = 2) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = lin.fitted, samples = v34.lin.sim.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = lin.lcr, samples = v34.lin.sim.lcr, pos = 6) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
