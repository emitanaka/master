...
```{r}
lineup(true = v1.lin.lcr, samples = v11.lin.sim.lcr, pos = 9) %>% 
...
```{r v12n-plot-lcr}
lineup(true = v1.lin.lcr, samples = v12.lin.sim.lcr, pos = 9) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v13n-plot21}
lineup(true = v1.lin.fitted, samples = v13.lin.sim.fitted, pos = 13) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v13n-plot6}
lineup(true = v1.lin.fitted, samples = v13.lin.sim.fitted, pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v13n-plot-lcr}
lineup(true = v1.lin.lcr, samples = v13.lin.sim.lcr, pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v14n-plot21}
lineup(true = v1.lin.fitted, samples = v14.lin.sim.fitted, pos = 13) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v14n-plot6}
lineup(true = v1.lin.fitted, samples = v14.lin.sim.fitted, pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v14n-plot-lcr}
lineup(true = v1.lin.lcr, samples = v14.lin.sim.lcr, pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v2-plots}
ggplot(v2.lin.fitted, aes(index, resm_std, color = subject)) + geom_point() + geom_hline(yintercept = 0)
ggplot(v2.lin.fitted, aes(index, resc_std, color = subject)) + geom_point() + geom_hline(yintercept = 0)
...
```{r v21n-plot21}
lineup(true = v2.lin.fitted, samples = v21.lin.sim.fitted, pos = 5) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = v2.lin.fitted, samples = v21.lin.sim.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = v2.lin.lcr, samples = v21.lin.sim.lcr, pos = 8) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v22n-plot22}
lineup(true = v2.lin.fitted, samples = v22.lin.sim.fitted, pos = 5) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v21n-plot6}
lineup(true = v2.lin.fitted, samples = v22.lin.sim.fitted, pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = v2.lin.lcr, samples = v22.lin.sim.lcr, pos = 8) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v23n-plot21}
lineup(true = v2.lin.fitted, samples = v23.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v23n-plot6}
lineup(true = v2.lin.fitted, samples = v23.lin.sim.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v21n-plot6-lcr}
lineup(true = v2.lin.lcr, samples = v23.lin.sim.lcr, pos = 20) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
##### Presence of outlying observations
```{r v21n-plot21}
lineup(true = v2.lin.fitted, samples = v24.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v24n-plot6}
lineup(true = v2.lin.fitted, samples = v24.lin.sim.fitted, pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v24n-plot6-lcr}
lineup(true = v2.lin.lcr, samples = v24.lin.sim.lcr, pos = 20) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
ggplot(v3.lin.fitted, aes(index, resc_std, color = subject)) + geom_point() + geom_hline(yintercept = 0)
ggplot(v3.lin.fitted, aes(sample = resc_std)) + geom_qq() + geom_qq_line(color = "red")
...
lineup(true = v3.lin.fitted, samples = v31.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
lineup(true = v3.lin.fitted, samples = v31.lin.sim.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
lineup(true = v3.lin.lcr, samples = v31.lin.sim.lcr, pos = 11) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
lineup(true = v3.lin.fitted, samples = v32.lin.sim.fitted, pos = 15) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = v3.lin.fitted, samples = v32.lin.sim.fitted, pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = v3.lin.lcr, samples = v32.lin.sim.lcr, pos = 11) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot21, fig.height=6}
lineup(true = v3.lin.fitted, samples = v33.lin.sim.fitted, pos = 2) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = v3.lin.fitted, samples = v33.lin.sim.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = v3.lin.lcr, samples = v33.lin.sim.lcr, pos = 6) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot21, fig.height=6}
lineup(true = v3.lin.fitted, samples = v34.lin.sim.fitted, pos = 2) %>% 
  ggplot(aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  facet_wrap(~.sample, ncol = 5)
...
```{r v31n-plot6, fig.height=6}
lineup(true = v3.lin.fitted, samples = v34.lin.sim.fitted, pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
...
```{r v32n-plot6-lcr, fig.height=6}
lineup(true = v3.lin.lcr, samples = v34.lin.sim.lcr, pos = 6) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
  xlab(NULL) + ylab(NULL) +
