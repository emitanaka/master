...
People always use the p-value or the test statistics to check the model. But why not using the graphical diagnostic. Graphical diagnostic can not only tell the problem but also can tell the cause of the problem.
