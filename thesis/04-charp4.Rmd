...
After fitting the data sets into the "best" model, we can estimate the fixed effect $\hat{\boldsymbol{\beta}}$ and predict the random effect $\hat{\mathbf{b}}$, with latter generated as a realisation from a normal distribution with zero mean and  variance-covariance matrix estimated from the data using either maximum likelihood or residual maximum likelihood [FIXME: cite Patterson, H. D., and R. Thompson. 1971. “Recovery of Inter-Block Information When Block Sizes Are Unequal.” Biometrika 58 (3): 545–54.]. Then we apply the method that @singer2017graphical stated to obtain these residuals and then acquire the plots.
...
>>>>>>> b018f281a1d1e8d03c8d93520aee304a0c362b3b
