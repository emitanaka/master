...
```{r sleep-eda, fig.height=8, fig.width=8, fig.cap="Exploration Data Analysis example in the sleep study case. It shows the random intercept and random slope with different subjects."}
...
```{r design, fig.height= 4,fig.width=8, fig.cap="Experimental design diagram",results='asis'}
