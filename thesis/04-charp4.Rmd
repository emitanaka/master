...
```{r table, echo=FALSE}
results <- data.frame(lineups = c("Marginal residual plot", "Condtional residual plot", "QQ plot for conditional residual", "QQ plot for confounded residual"), version1 = c('1/48', '0/42', '3/49', '2/44'), version2 = c('3/44', '4/53', '9/48 **', '5/49 .'), version3 = c('12/58 ***', '21/55 ***', '26/53 ***', '11/57 ***'))
